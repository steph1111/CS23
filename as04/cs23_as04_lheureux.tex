          ...
          \begin{enumerate}[leftmargin=*]
              ...
              \item[(b)] How many edges must the graph have to guarantee all vertices
                ...
                \begin{proof}
                    ...
                    Let $G$ be a graph in which $|V| = n$ and every vertex is degree 2.
                    ...
                    Since every vertex has degree 2, the sum of the degrees is:
                    \[
                    \sum_{i=1}^{n} 2 = 2n \quad \Rightarrow \quad e = \frac{2n}{2} = n
                    \]

                    Therefore, the $G$ must have at least $n$ edges to ensure every vertex is at least degree 2.
